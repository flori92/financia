    ...
    <ThemeProvider defaultTheme={userProfile.preferences.theme || "light"}>
      <div className="w-full">
        {userProfile.role === "entrepreneur" && (
          <EntrepreneurInterface profile={userProfile}>{children}</EntrepreneurInterface>
        )}
        {userProfile.role === "expert" && (
          <ExpertInterface profile={userProfile}>{children}</ExpertInterface>
        )}
        {userProfile.role === "admin" && (
          <AdminInterface profile={userProfile}>{children}</AdminInterface>
        )}
      </div>
    </ThemeProvider>
  );
