      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-yellow-50 border border-yellow-100 cursor-pointer hover:bg-yellow-100 transition-all">
              <TrendingDown className="text-yellow-600 flex-shrink-0 mt-0.5 w-4 h-4" strokeWidth={1.5} />
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium text-yellow-900">Trésorerie prévisionnelle</div>
                <div className="text-xs text-yellow-700 mt-0.5">Seuil critique dans 15j</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {[
              ...
              { type: "in", label: "Tech Solutions SAS", desc: "Facture #INV-2023-458", amount: "+8 750 €", time: "Il y a 2j" }
            ].map((tx, i) => (
